                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="<?php echo ADMINROOT; ?>/forgot">Reset</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <span class="gl-text u-s-m-b-30">Enter your email or username to get a reset
                                            link</span>
                                        <form class="l-f-o__form">
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" type="text"
                                                    id="reset-email" placeholder="Enter E-mail">
                                            </div>
                                            <div class="u-s-m-b-30">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <a class="gl-link" href="<?php echo ADMINROOT; ?>">Back to Login</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
