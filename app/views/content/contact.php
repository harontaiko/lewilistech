                        ...
                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                            <div class="contact-o u-h-100">
                                <div class="contact-o__wrap">
                                    ...
                                    <span class="contact-o__info-text-2">(+254) 710 577 667</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                            <div class="contact-o u-h-100">
                                <div class="contact-o__wrap">
                                    ...
                                    <span class="contact-o__info-text-2">00100 Nairobi Moi Avenue, Cubes
                                        Exhibition</span>

                                    <span class="contact-o__info-text-2">Nairobi</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                            <div class="contact-o u-h-100">
                                <div class="contact-o__wrap">
                                    ...
                                    <span class="contact-o__info-text-2">6 Days a Week</span>

                                    <span class="contact-o__info-text-2">From 8 AM to 7 PM</span>
                                </div>
                            </div>
                        </div>
                    </div>
