...
(function ($) {
  ...
  var $filterGridWrapper = $(".filter__grid-wrapper"),
    ...
    $modalProductDetailElementThumbnail = $(
      "#js-product-detail-modal-thumbnail"
    ),
    $shopCategoryToggleSpan = $(
      ".shop-w__category-list .has-list > .js-shop-category-span"
    ), // Recursive
  ...
  RESHOP.modalProductDetailInit = function () {
    if (
      $modalProductDetailElement.length &&
      $modalProductDetailElementThumbnail.length
    ) {
